...
public class FindFood extends FragmentActivity implements OnMapReadyCallback
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //check permission
        if(ActivityCompat.checkSelfPermission(FindFood.this, Manifest.permission.ACCESS_FINE_LOCATION) == PackageManager.PERMISSION_GRANTED){
            //When permission granted call method
            getCurrentLocation();
        }else{
            //When permission denied, request permission
            ActivityCompat.requestPermissions(FindFood.this, new String[]{Manifest.permission.ACCESS_FINE_LOCATION}, 44);
        }
    }
        ...
        if(reference.equals("Your Location")){
            ...
            placesClient.fetchPlace(request).addOnSuccessListener(new OnSuccessListener<FetchPlaceResponse>() {
                ...
                public void onSuccess(FetchPlaceResponse response) {
                    ...
                    Intent intent = new Intent(FindFood.this, DisplayInfoActivity.class);
                    intent.putExtra(EXTRA_NAME, name);
                    intent.putExtra(EXTRA_ADDRESS, address);
                    intent.putExtra(EXTRA_PHONE, phone);
                    intent.putExtra(EXTRA_TIME, (Serializable) time);

                    Toast.makeText(FindFood.this, "Loading information", Toast.LENGTH_SHORT).show();
                ...
                public void onFailure(@NonNull Exception exception) {
                    if (exception instanceof ApiException) {
                        Toast.makeText(FindFood.this, exception.getMessage() + "", Toast.LENGTH_LONG).show();
                    }
                }
            });
        }
