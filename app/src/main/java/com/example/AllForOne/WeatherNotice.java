...
public class WeatherNotice extends AppCompatActivity {

    private static final String OPEN_WEATHER_MAP_URL = "https://api.openweathermap.org/data/2.5/weather?q=Vancouver&units=metric";
    private static final String OPEN_WEATHER_MAP_API = "b330286ddcedebf2a98861481282be9c";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        start.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(WeatherNotice.this, Navigation.class));
            }
        });
        ...
        if (ActivityCompat.checkSelfPermission(WeatherNotice.this, ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
            return;
        }
        mFusedLocationProviderClient.getLastLocation().addOnSuccessListener(WeatherNotice.this, new OnSuccessListener<Location>() {
            @Override
    ...
    public String[] getJSONResponse(){
        ...
        try {
            if (jsonWeather != null) {
                ...
                String description = details.getString("description").toLowerCase(Locale.CANADA);
